...
HELIOS produces signed audit evidence for genomics pipelines. It **reads export JSON from disk** — it does not call other product APIs or orchestrate them. For API conformance, see [Helix](https://github.com/SynapticFour/Helix) / [HelixTest](https://github.com/SynapticFour/HelixTest). How the two differ: [Helix vs HELIOS](https://github.com/SynapticFour/Helix/blob/main/docs/HELIX_VS_HELIOS.md).
